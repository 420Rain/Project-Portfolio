							...
							int *nID4, int *nID5, int *nID6, int *nID7, int *nID8, int *nID9, int *nID10, int *nID11, int *nID12, int *nID13, int *nID14)
{
	...
	if (cBookOption == 'B' && *cS1 == 'X' && *cS2 == 'X' && *cS3 == 'X' && *cS4 == 'X' && *cS5 == 'X' && *cS6 == 'X' && *cS7 == 'X' && *cS8 == 'X' && *cS9 == 'X' && *cS10 == 'X' && *cS11 == 'X' && *cS12 == 'X' && *cS13 == 'X' && *cS14 == 'X')
	{
		printf("\nCannot Book a Reservation. The Bus for Route (%c) is Already Full\n", cRoute);
	}
	else if (cBookOption == 'C' && *cS1 == 'O' && *cS2 == 'O' && *cS3 == 'O' && *cS4 == 'O' && *cS5 == 'O' && *cS6 == 'O' && *cS7 == 'O' && *cS8 == 'O' && *cS9 == 'O' && *cS10 == 'O' && *cS11 == 'O' && *cS12 == 'O' && *cS13 == 'O' && *cS14 == 'O')
	{
